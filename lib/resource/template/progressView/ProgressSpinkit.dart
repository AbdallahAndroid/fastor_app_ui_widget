...
class ProgressSpinkit {
  ...
  static Widget centerPage(BuildContext context ) {
    var stack = Stack(children: [
      ...
      Positioned(child:  ProgressSpinkit.get(context), left: 0, right: 0, top: DeviceTools.getHalfHeight(context)-50 )
    ],);
  ...
  static Widget getFixedSize(BuildContext context , double size){
