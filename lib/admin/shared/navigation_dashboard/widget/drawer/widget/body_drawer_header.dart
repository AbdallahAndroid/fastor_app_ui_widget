  ...
  contentUIHeader(BuildContext context) {
    return   GestureDetector(
        child: Container(
          ...
          height:   170.h + NotchBarSizeHelper.getTop(context),
          ...
          child:  Column(
            ...
            children: [
              ...
              SizedBox( height:  NotchBarSizeHelper.getTop(context),),
  ...
  tabLogout(BuildContext context) {
    return GestureDetector(
      onTap: (){
        ...
        RouterPage.profileMain(context);
      },
      child: Container(
        color: Colors.transparent,
        margin: EdgeInsets.only(top: NotchBarSizeHelper.getTop(context)),
        padding: EdgeInsets.all( 16.h ),
        child: Icon( Icons.login_outlined, color: AppColors.white, size: 24.h ,),
      ),
    );
  }
