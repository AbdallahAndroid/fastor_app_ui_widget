...
import 'package:fastor_app_ui_widget/customWidget/responsive_views/helper/PortraitToLandscapeUtilsResponsiveApp.dart';
...
class PaginateBarApp extends StatefulWidget{
...
class PaginateBarState extends State<PaginateBarApp> {
  ...
  Widget contentUI(){
    return Container(
      ...
      height: PaginateBarApp.getHeightFrame(context),
  ...
  Widget barTabButtonAndSearchBarResponsiveBetweenMobileAndDesktop(){
    return   PortraitToLandscapeUtilsResponsiveApp.convertChildrenFromPortraitVerticalToBeLandscapeHorizontal(
        context: context,
