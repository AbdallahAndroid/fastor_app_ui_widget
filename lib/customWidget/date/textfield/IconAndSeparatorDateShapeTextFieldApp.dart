 ...
 *
 --------------------- example birthday shape
    ...
    Widget birthday() {
    return IconAndSeparatorDateShapeTextFieldApp(
 ...
 */
class IconAndSeparatorDateShapeTextFieldApp extends StatefulWidget {
  ...
  IconAndSeparatorDateShapeTextFieldApp( {
    this.title,
    this.hint,
    this.dateSelected,
    required this.icon,
...
class _CalenderCustomState extends State<IconAndSeparatorDateShapeTextFieldApp> {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: ColumnApp( children: [
        ...
        iconAndDividerAndTextFieldTapWidget(),
  ...
  Widget iconAndDividerAndTextFieldTapWidget(){
    return GestureDetector(
      child: iconAndDividerAndTextField(),
      onTap: () async {
        Log.i("calender tab");
  ...
  Widget iconAndDividerAndTextField(){
    return Container(
