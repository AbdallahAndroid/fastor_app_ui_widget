...
import 'package:fastor_app_ui_widget/core/utils/date/DatePickerHelper.dart';
...
class DateRangeTextFieldApp extends StatefulWidget {
...
class _DateTextFieldFastorState extends State<DateRangeTextFieldApp> {
  ...
  Widget errorTextWidget() {
    ...
    var txt = TextApp("${widget.errorMessageBackend}",
