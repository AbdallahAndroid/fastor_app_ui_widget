...
class MobileCountryApp extends StatefulWidget {
  ...
  @override
  _MobileCountryAppState createState()  => _MobileCountryAppState();

}
class _MobileCountryAppState extends State<MobileCountryApp> {
  ...
  Widget rowCountryAndSpinAndPhone(){
    // var row =  RowUtils.child1_WrapWidth_child2_expanded( country(), tf_phone(),
    //     gravityLayout: Alignment.topLeft );

    var row = RowScrollApp(children: [
