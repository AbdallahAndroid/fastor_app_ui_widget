...
class TextFieldPasswordApp extends StatefulWidget {
...
class _TextFieldPasswordState extends State<TextFieldPasswordApp> {
  ...
  Widget password() {
    return TextFieldApp(
      ...
      /// password config
      validatorCustom: widget.validatorCustom?? ValidatorApp.pass(error_text: "*Enter password at least 8 char." ),
