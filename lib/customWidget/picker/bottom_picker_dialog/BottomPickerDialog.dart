...
import 'package:fastor_app_ui_widget/customWidget/picker/bottom_picker_dialog/logic/BottomPickerController.dart';
import 'package:fastor_app_ui_widget/customWidget/picker/bottom_picker_dialog/widget/ItemSelectedOrUnSelectedShape.dart';
...
import 'package:fastor_app_ui_widget/customWidget/picker/listview_picker/widget/ListItemPicker.dart';
...
class BottomPickerDialog extends StatefulWidget {
  ...
  void setPreviousSelectedIfFound() {
    ...
    for( var entity in  dataEntities ) {
      if (entity.id ==  previousSelectedId || entity.title ==  previousSelectedId ) {
