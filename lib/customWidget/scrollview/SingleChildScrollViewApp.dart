...
class SingleChildScrollViewApp {
  ...
  static Widget t(BuildContext context, Axis axis, List<Widget> children, double minesMargin, Color backgroundAllScreen) {
    if( axis == Axis.horizontal ) {
      ...
      return SingleChildScrollViewApp.vList( context, children, minesMargin, backgroundAllScreen);
    }
  }
  ...
  static Widget vList( BuildContext context, List<Widget> children,
    ...
    //cal height
    double statusHeight = StatusBarSizeHelper.getHeight(context);
