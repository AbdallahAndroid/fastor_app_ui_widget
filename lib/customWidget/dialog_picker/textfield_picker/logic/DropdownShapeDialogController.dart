...
import 'package:fastor_app_ui_widget/customWidget/dialog_picker/textfield_picker/IconAndSeparatorTextFieldDialogPicker.dart';
import 'package:fastor_app_ui_widget/customWidget/toast/ToolsToast.dart';
import 'package:flutter/material.dart';


extension DropdownShapeDialogController on IconAndSeparatorTextFieldDialogState {
  ...
  void validaBeforeOpenDialogPicker() {
    ...
    dialogBottomSheepPickerGeneric(
        context: context,
        titleDialog: widget.hint??"Choose".tra(),
