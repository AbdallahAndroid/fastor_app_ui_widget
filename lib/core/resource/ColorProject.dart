...
class AppColors {
  ...
  static var blurCard =
      Colors.blueAccent.withOpacity(0.5); //.withOpacity( 0.4 );

  /// dialog
  static var backgroundDialogDismissCaseHaveMessageTypeEffectGlass =
  ...
  static var backgroundCardDialogTransparent =
      Colors.white.withOpacity(0.6); //figma make it white ffffff
  static var backgroundDialogDismissAreaTypeEffectGlass =
      Colors.black.withOpacity(0.4);
  static Color dialogDialogDismissAreaTypeNormal =
      Color(0xffFFFFFF).withOpacity(0.6);
  static var backgroundDialogFixingPreviousScreenInCaseWhite =
      Colors.black.withOpacity(0.4);
  static var backgroundDialogDismissAreaTypeEffectGlassPortrait =
  ...
  static var textFieldLabel = Colors.black.withOpacity(0.60);

  /// figma;
  static var textFieldBoarder = Colors.black.withOpacity(0.38);
  ...
  /// icon
  static var iconGlassBackgroundWhiteTransparent =
  ...
  static var areaAroundDialogTransparent =
  ...
  /// red
  static var primaryTabTransparent =
      Color(0xffCE1226).withOpacity(0.2); // figma
  ...
  static var boarderBottomSheet = Color(0xff9E9E9E);
  ...
  /// selected
  static var selectedItemTransparentStatusSelectedBackground =
      Color(0xffCE1226).withOpacity(0.05);
